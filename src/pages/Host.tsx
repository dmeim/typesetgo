    ...
    return (
      <RoomPage>
        <div className="mx-auto max-w-md space-y-5 py-12 text-center">
          ...
          <Link to="/connect" className="block py-2">
            Back to Connect
          </Link>
        </div>
      </RoomPage>
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="flex flex-wrap items-start justify-between gap-5">
          <div className="space-y-2">
            <Link to="/connect" className="inline-block py-2 text-sm">
              ← Connect
            </Link>
        ...
        >
          ...
          <fieldset disabled={locked} className="min-w-0 space-y-4">
            ...
            >
              ...
              <RoomButton onClick={openThemes}>Participant theme</RoomButton>
              <SoundController
                disabled={locked}
                settings={settings}
        ...
        >
          <fieldset disabled={locked} className="space-y-4">
            ...
            {themeError && (
              <p role="alert">
                {themeError}
                <RoomButton onClick={loadThemes}>Retry</RoomButton>
              </p>
            )}
            <label className="block space-y-2 text-sm">
              Theme preset
