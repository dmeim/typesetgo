  ...
  return (
    <div className="flex items-center justify-center gap-4 mb-6 w-full">
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 h-1 w-full scale-x-0 transition-transform duration-200 group-hover:scale-x-100 rounded-b-lg" style={{ backgroundColor: GLOBAL_COLORS.brand.primary }}></div>
      </button>
    </div>
  );
}
