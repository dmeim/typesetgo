    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className={`space-y-4 transition-opacity duration-200 ${!settings.soundEnabled ? "opacity-50 pointer-events-none" : ""}`}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                <select
                    ...
                    onChange={(e) => onUpdateSettings({ typingSound: e.target.value })}
                    className="w-full rounded bg-gray-700 px-3 py-2 text-sm text-gray-200 focus:outline-none focus:ring-2"
                    style={{ "--tw-ring-color": GLOBAL_COLORS.brand.primary } as any}
                >
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                <select
                    ...
                    onChange={(e) => onUpdateSettings({ warningSound: e.target.value })}
                    className="w-full rounded bg-gray-700 px-3 py-2 text-sm text-gray-200 focus:outline-none focus:ring-2"
                    style={{ "--tw-ring-color": GLOBAL_COLORS.brand.primary } as any}
                >
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                <select
                    ...
                    onChange={(e) => onUpdateSettings({ errorSound: e.target.value })}
                    className="w-full rounded bg-gray-700 px-3 py-2 text-sm text-gray-200 focus:outline-none focus:ring-2"
                    style={{ "--tw-ring-color": GLOBAL_COLORS.brand.primary } as any}
                ...
                <button
                    type="button"
                    onClick={() => settings.errorSound && playPreview('error', settings.errorSound)}
